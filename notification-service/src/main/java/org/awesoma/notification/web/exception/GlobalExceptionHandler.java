...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleConflict(ConflictStateException exception, ServerWebExchange exchange) {
        return problem(HttpStatus.CONFLICT, "Conflicting state", exception.getMessage(), exchange);
    }

    /** A unique or check constraint caught what the service did not; its details stay in logs. */
